    ...
    <>
      ...
      <section className="w-full bg-neutral-50 py-24 md:py-28 px-6">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
          <a
            href={PHONE_HREF}
            className="flex items-center gap-5 p-7 bg-[#F2EFE9]/60 rounded-[40px_8px_40px_8px] border border-neutral-200/60 hover:border-[#707E54]/50 transition-colors group"
          >
            <div className="w-12 h-12 rounded-full bg-[#707E54] text-neutral-50 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
          ...
          <a
            href={`mailto:${EMAIL}`}
            className="flex items-center gap-5 p-7 bg-[#F2EFE9]/60 rounded-[8px_40px_8px_40px] border border-neutral-200/60 hover:border-[#707E54]/50 transition-colors group"
          >
            <div className="w-12 h-12 rounded-full bg-[#707E54] text-neutral-50 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
          ...
          <div className="flex items-center gap-5 p-7 bg-[#F2EFE9]/60 rounded-[8px_40px_8px_40px] border border-neutral-200/60">
            <div className="w-12 h-12 rounded-full bg-[#a36527] text-neutral-50 flex items-center justify-center shrink-0">
          ...
          <div className="flex items-center gap-5 p-7 bg-[#F2EFE9]/60 rounded-[40px_8px_40px_8px] border border-neutral-200/60">
            <div className="w-12 h-12 rounded-full bg-[#a36527] text-neutral-50 flex items-center justify-center shrink-0">
      ...
      {/* How to reach us */}
      <section className="w-full bg-[#707E54]/5 py-24 px-6">
      ...
      {/* Closing call band */}
      <section className="w-full bg-[#707E54] text-neutral-50 py-24 px-6">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          <h2 className="font-serif text-3xl md:text-4xl tracking-[0.15em] uppercase mb-6 leading-tight">
            {t("closing.title")}
          </h2>
          <p className="text-base md:text-lg text-[#F2EFE9]/90 leading-relaxed font-light mb-10 max-w-xl">
            {t("closing.body")}
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              asChild
              className="bg-[#E5DCC6] text-neutral-900 px-10 py-6 rounded-full text-xs font-semibold tracking-widest uppercase hover:bg-[#F2EFE9] transition-colors shadow-md h-auto"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="border-[#E5DCC6] text-[#E5DCC6] px-10 py-6 rounded-full text-xs font-semibold tracking-widest uppercase hover:bg-white/10 transition-colors h-auto bg-transparent"
            >
