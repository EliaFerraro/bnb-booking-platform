...
function ServicesContent({ locale }: { locale: string }) {
  ...
  return (
    <>
      ...
      <section className="w-full bg-[#707E54] py-24 px-6 md:px-12 lg:px-24 text-neutral-50 overflow-hidden">
      ...
      <section className="w-full bg-[#F2EFE9] py-24 px-6 md:px-12 lg:px-24 text-neutral-950">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-14 items-start justify-items-center">
            {INCLUDED.map(({ key, icon }) => (
              <div key={key} className="flex flex-col items-center text-center max-w-44">
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full border-2 border-[#707E54] flex items-center justify-center mb-5 text-[#707E54] shadow-sm">
                  <HugeiconsIcon
                    icon={icon}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            {ON_REQUEST.map((key) => (
              ...
              >
                <span className="font-serif text-2xl text-[#a36527] leading-none">—</span>
                <div>
