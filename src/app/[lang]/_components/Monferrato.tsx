      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center">
          ...
          <p className="text-base md:text-lg text-neutral-700 leading-relaxed font-light mb-10 text-justify">
            Una distesa infinita di colline pettinate dai vigneti. Il Monferrato
            è una terra generosa che regala eccellenze enogastronomiche uniche
            al mondo e borghi ricchi di storia. Un paesaggio autentico in cui
            perdersi, dove i colori cambiano con le stagioni e regalano tramonti
            indimenticabili.
          </p>
