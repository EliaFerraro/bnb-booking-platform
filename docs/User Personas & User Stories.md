...
| US-005  | As a **Guest**, I want to pay in the app so that I can forget about money during the trip | 85 | 13 |
...
| US-N      | Notes         | Priority | Story Points |
| -------- | ------- | --------:| ------- |
| US-011  | As a **Host**, I want to see the list of the booking requests so that I can approve or discard them   | 100 | 5 |
| US-012  | As a **Host**, I want to automatically synch calendar dates already taken from other platforms such as Booking and AirBnb (through iCal) | 100 | 13 |
| US-013  | As a **Host**, I want to send a message to the guest or respond to them so that I can communicate and negotiate with them  | 70 | 8 |
| US-014  | As a **Host**, I want to manage the calendar of open dates and closed dates so that guest can bookonly choosen dates  | 90 | 5 |
| US-015  | As a **Host**, I want to edit the price for each room both for guests number and date period (high/low season) | 85 | 8 |
| US-016  | As a **Host**, I want to edit the minimum number of nights for staying for each date range or periodically (eg. in weekends) | 75 | 5 |
| US-017  | As a **Host**, I want to share the booking offer (preventivo) with a single click so that the experience is more professional | 80 | 5 |
| US-018  | As a **Host**, I want to receive an alert if I have not answered to a request before its arrival date  | 60 | 3 | 
| US-019  | As a **Host**, I want to manage the list of my rooms so that I can edit photos and details for each of them  | 50 | 5 |
| US-020  | As a **Host**, I want to mark a booking as paid, so that I can track booking status | 40 | 3 |
| US-021  | As a **Host**, I want to see a dashboard of all bookings and earnings so that I can take future proof decisions | 40 | 3 |
